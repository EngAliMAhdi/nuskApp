...
@section('content')
    <div class="row">
        ...
        <div class="mb-4 row">
            <div class="mb-4 col-lg-4 col-sm-6 mb-lg-0">
                <div class="card">
                    <div class="p-3 card-body">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="mb-0 text-sm text-capitalize font-weight-bold">المستخدمين </p>
                ...
                <div class="card">
                    <div class="p-3 card-body">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="mb-0 text-sm text-capitalize font-weight-bold">الفنادق </p>
                                    <h5 class="mb-0 font-weight-bolder">
                                        {{ $data['hotel'] }}
                                    </h5>
                                </div>
                ...
                <div class="card">
                    <div class="p-3 card-body">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="mb-0 text-sm text-capitalize font-weight-bold">الشقق </p>
                                    <h5 class="mb-0 font-weight-bolder">
                                        {{ $data['partment'] }}
                                    </h5>
                                </div>
                ...
                <div class="card">
                    <div class="p-3 card-body">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="mb-0 text-sm text-capitalize font-weight-bold">وسائل النقل </p>
                                    <h5 class="mb-0 font-weight-bolder">
                                        {{ $data['transport'] }}
                                    </h5>
                                </div>
                ...
                <div class="card">
                    <div class="p-3 card-body">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="mb-0 text-sm text-capitalize font-weight-bold">مركبات </p>
                                    <h5 class="mb-0 font-weight-bolder">
                                        {{ $data['vehicles'] }}
                                    </h5>
                                </div>
                ...
                <div class="card">
                    <div class="p-3 card-body">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="mb-0 text-sm text-capitalize font-weight-bold">وسائل السائقين </p>
                                    <h5 class="mb-0 font-weight-bolder">
                                        {{ $data['drivers'] }}
                                    </h5>
                                </div>
