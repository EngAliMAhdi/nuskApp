                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="companion_name" class="form-control"
                                    value="{{ old('companion_name', $data->companion_name) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="guide_name" class="form-control"
                                    value="{{ old('guide_name', $data->guide_name) }}">
                                @error('guide_name')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="companion_phone" class="form-control"
                                    value="{{ old('companion_phone', $data->companion_phone) }}">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                {{-- زر تحميل الملف الحالي إن وجد --}}
                                @if ($data->license_file)
                                    <a href="{{ asset('storage/' . $data->license_file) }}"
                                        class="mt-2 btn btn-primary btn-sm" target="_blank">
                                        تحميل الملف الحالي
                                    </a>
                                @endif
