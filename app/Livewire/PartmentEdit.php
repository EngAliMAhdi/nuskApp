...
class PartmentEdit extends Component
{
    use WithFileUploads;
    ...
    public function mount($id)
    {
        ...
        foreach ($data->rooms as $index => $serv) {
            $this->rooms2[$index] = [
                ...
                'service' => $serv->services->pluck('pivot.service_id')
            ];
    ...
    public function removeRoom2($index)
    {
        ...
        return redirect()->route('partment.edit', ['id' => $this->id]);
    }
    ...
    public function saveRoom()
    {
        ...
        $this->show = false;
        $this->show1 = false;
        session()->flash('success', 'تم تعديل الشقة بنجاح!');
    ...
    public function save()
    {
        ...
        Partment::where('id', $this->id)->update($data);
        $this->show0 = false;
        $this->show = true;

        Session::flash('success', 'تم تعديل شقة بنجاح.');
    }
    public function render()
    {
        return view('livewire.partment-edit');
    }
}
